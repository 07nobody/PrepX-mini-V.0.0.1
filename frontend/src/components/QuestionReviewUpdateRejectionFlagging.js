...
const QuestionReviewUpdateRejectionFlagging = () => {
  ...
  const handleFlagSubmit = async () => {
    ...
    try {
      await axios.post(`/api/questions/${selectedQuestion.id}/update-review-flag`, {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Question Review, Update, Rejection, and Flagging</h1>
      {questions.length > 0 ? (
        <ul>
        ...
        <p>No questions available for review, update, rejection, and flagging.</p>
      )}
...
export default QuestionReviewUpdateRejectionFlagging;
