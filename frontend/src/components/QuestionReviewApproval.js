...
const QuestionReviewApproval = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Question Review and Approval</h1>
      {questions.length > 0 ? (
        <ul>
        ...
        <p>No questions available for review and approval.</p>
      )}
...
export default QuestionReviewApproval;
